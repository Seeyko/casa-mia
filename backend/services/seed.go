...
func SeedIfEmpty(db *Database) {
	...
	db.DB.Exec(`INSERT INTO menu_items (category_id, name, description, price, sort_order) VALUES
		...
		(1, 'Diavola', 'Tomate, parmesan, mozza, spianata (saucisson piquant italien)', '10,50€', 7),
		...
		(1, '4 Stagioni', 'Tomate, parmesan, mozza, anchois, porchetta, artichauts, champignons', '13,00€', 13),
		...
		(1, 'Burrata', 'Tomate, parmesan, mozza, roquette, tomates cerise, speck, burrata', '14,00€', 18),
		(1, 'Tonno', 'Tomate, mozza, parmesan, pesto, thon, oignons rouge, tomate cerise', '14,00€', 19),
	...
	// === PIZZAS CREME (cat 2) ===
	db.DB.Exec(`INSERT INTO menu_items (category_id, name, description, price, sort_order, badge, note) VALUES
		(2, 'Capre e Miele', 'Creme, parmesan, mozza, chevre, miel, guanciale (lard italien), roquette', '12,00€', 1, '', ''),
		(2, 'Taleggio', 'Creme, parmesan, mozza, guanciale (lard italien), PDT sautees, oignons rouges, taleggio', '12,00€', 2, '', ''),
		(2, 'Bologne', 'Creme, pesto de pistaches, parmesan, mozza, mortadelle, eclats de pistaches', '13,00€', 3, '', ''),
		(2, 'Manzo', 'Creme, parmesan, mozza, gorgonzola, bresaola (boeuf seche), roquette', '13,00€', 4, '', ''),
		...
		(2, 'Raviole', 'Creme, mozza, parmesan, ravioles de Romans, jambon cru, pesto', '14,00€', 7, '', ''),
		...
		(2, 'Camembert au Four', 'Camembert cuit dans notre pate a pizza accompagne de charcuterie italienne', '16,00€', 12, 'NEW', ''),
		(2, 'Tartufo', 'Creme de truffe, mozza, parmesan, magret fume, camembert di bufala', '18,00€', 13, '★', 'De mai a aout, possibilite de carpaccio de truffes fraiches d''ete — 5,00€')
	`)
	...
	// === PLANCHES (cat 5) ===
	db.DB.Exec(`INSERT INTO menu_items (category_id, name, description, price, sort_order) VALUES
		(5, 'Charcuteries ou Charcuteries Fromages', '', '7,00€ / personne', 1),
		(5, 'Planche Raclette', '200g de Taleggio DOP et assortiment de charcuterie italienne', '9,50€ / personne', 2)
	`)
	...
	// === DOLCI (cat 7) ===
	db.DB.Exec(`INSERT INTO menu_items (category_id, name, description, price, sort_order) VALUES
		(7, 'Tiramisu traditionnel au cafe', '', '3,90€', 1),
	...
	db.DB.Exec(`INSERT INTO menu_items (category_id, name, description, price, sort_order) VALUES
		...
		(10, 'Saumon Gravelax', '', '7,00€ / pers.', 4),
		(10, 'Carpaccio de Bresaola', '', '7,00€ / pers.', 5)
	`)
	...
	db.DB.Exec(`INSERT INTO menu_items (category_id, name, description, price, sort_order) VALUES
		...
		(11, 'Mini burger polpettes de poulet', '', '2€ / piece', 3),
		(11, 'Tramezini saumon fume', '', '2€ / piece', 4),
		(11, 'Mini croq''Truffe', '', '2€ / piece', 5),
		(11, 'Tourte Napolitaine', '', '2€ / piece', 6),
	...
	db.DB.Exec(`INSERT INTO menu_items (category_id, name, description, price, sort_order) VALUES
		...
		(12, 'Tomates cerises, mozza, speck', '', '', 2),
		(12, 'Melon, jambon cru', '', '', 3),
		(12, 'Bresaola, roquette, parmesan, tomates', '', '', 4),
		(12, 'Crevettes marinees basilic citron', '', '', 5),
